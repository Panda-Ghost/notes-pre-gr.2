...
$$
\begin{aligned}
&\text{let } t:=\frac{n'-n}{r}=\frac{n'}{l'}-\frac{n}{l} \overset{l\to \infty}{=}\frac{n'}{f'}\overset{l\to \infty}{=}-\frac{n}{f} \\
\implies &\frac{t}{t}=\frac{n'}{l'} / t +\frac{-n}{l} / t=\frac{n'}{l'} \cdot \frac{f'}{n'}+ \frac{-n}{l} \cdot \frac{f}{-n}=\frac{f'}{l'}+\frac{f}{l}=1
\end{aligned}
$$
