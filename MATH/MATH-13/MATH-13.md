...
=& \;  2\left[\sum_{i=1}^{n}\sum_{j=1}^{n}q_{i}a_{i}b_{i}q_{j} - \left(\sum_{i=1}^{n}q_{i}b_{i}\right)\left(\sum_{j=1}^{n}q_{j}a_{j}\right)\right]\\
=& \;  2\left[\left(\sum_{i=1}^{n}q_{i}a_{i}b_{i}\right) - \left(\sum_{i=1}^{n}q_{i}b_{i}\right)\left(\sum_{j=1}^{n}q_{j}a_{j}\right)\right]\\
\end{aligned}
$$
