...
书目作品进行深度阅读，自选角度作文，体裁不限（诗歌体除外）。 作业要求： 1）字数2000字以上,3000字以下； 3）引用规范：参考或引用他人观点或文章内容，必须标明出处。引用专著内容，需注明书名、作者、译者、出版社、出版年份、页码；引用论文，需注明标题、作者、文献来源（期刊名），刊发年份和期数；引用格式采取GB/T 7714-2015的标准 书目及版本：（请重点关注译者和出版社两个信息） 《老人与海》，李育超译，人民文学出版社 帮我完成上面的作业，符合下面的要求 Replace all transition words and conjunctions in the sentences with the most basic and commonly used ones. Use simple expressions，avoiding complex vocabulary. Ensure the logical connections between sentences are clear. Rewrite the above text. The writing style should balance between formal academic writing and conversational expression. Ensure that every sentence has a clear subject. Avoid using long or complex sentences. Use short sentences as much as possible. 以自然的中文生成，避免小标题，避免 markdown 格式